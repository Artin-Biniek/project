...
from utils import VERIFIABLE_CREDENTIAL, required_attributes, JSON_LD_SCHEMA


class ValidVCGenerator:
    def __init__(self):
        self.results = []
        self.ignored_attrs = ['@protected', '@id', '@type', '@version']
...
print(generator.generate_attribute(VERIFIABLE_CREDENTIAL, json_ld_schema['@context'][VERIFIABLE_CREDENTIAL]))
